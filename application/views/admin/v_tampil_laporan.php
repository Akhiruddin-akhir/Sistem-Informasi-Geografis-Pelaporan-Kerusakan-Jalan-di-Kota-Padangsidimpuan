<?php 
	$proses = $this->db->get_where('tb_lap', ['status' => 'BELUM DIPROSES'])->num_rows(); ['status']=="BELUM DIPROSES";
  $valid = $this->db->get_where('tb_lap', ['status' => 'VALID'])->num_rows();
  $survey = $this->db->get_where('tb_lap', ['status' => 'SURVEY'])->num_rows();
  $tidakvalid = $this->db->get_where('tb_lap', ['status' => 'TIDAK VALID'])->num_rows();
  $sudahdiperbaiki = $this->db->get_where('tb_lap', ['status' => 'SUDAH DIPERBAIKI'])->num_rows();
?>
	...
	<div class="row my-3">
		<div class="col-lg-3">
            <div class="card shadow">
	            <div class="card-body">
	              <h6><i class="fas fa-fw fa-times"></i> Belum ditanggapi</h6>
	              <h6 class="text-muted mt-2">Jumlah data: <span class="bg-info py-1 px-2 rounded"><?= $proses;?></span></h6>
	            </div>
            </div>
        </div>
        <div class="col-lg-3">
            <div class="card shadow">
	            <div class="card-body">
	              <h6><i class="fas fa-fw fa-sync"></i> Valid</h6>
        ...
        <!--<div class="col-lg-3">
        	<div class="card shadow">
	            <div class="card-body">
	              <h5><i class="fas fa-fw fa-check"></i> Survey</h5>
	              <h6 class="text-muted mt-3">Jumlah data: <span class="bg-info py-1 px-2 rounded"><?= $survey; ?></span></h6>
	            </div>
	        </div>
	    </div>-->
        <div class="col-lg-3">
	        <div class="card shadow">
	            <div class="card-body">
	              <h6><i class="fas fa-fw fa-hammer"></i> Tidak Valid</h6>
	              <h6 class="text-muted mt-3">Jumlah data: <span class="bg-info py-1 px-2 rounded"><?= $tidakvalid; ?></span></h6>
	            </div>
	        </div>
        </div>
        <div class="col-lg-3">
	        <div class="card shadow">
	            <div class="card-body">
	              <h6><i class="fas fa-fw fa-check-double"></i> Sudah Diperbaiki</h6>
	              <h6 class="text-muted mt-3">Jumlah data: <span class="bg-info py-1 px-2 rounded"><?= $sudahdiperbaiki; ?></span></h6>
	            </div>
	        </div>
        </div>
  	</div>
